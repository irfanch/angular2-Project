System.register(['angular2/core', 'angular2/router', 'angular2/common', './basicValidators', './user.service', './user'], function(exports_1, context_1) {
    "use strict";
            ...
            NewUserComponent = (function () {
                function NewUserComponent(fb, _router, _routeParams, _userService) {
                    ...
                    this.form = fb.group({
                        ...
                        email: ['', basicValidators_1.BasicValidator.email],
                        phone: [],
                        address: fb.group({
                            street: [],
                            suite: [],
